module Members
  class PasswordResetsController < Members::MembersController
    ...
    def create
      users = Members::AdminUser.where(:email => params[:recover_email]).all
    ...
    def update
      ...
      if params[:members_admin_user][:password].empty? || params[:members_admin_user][:password_confirmation].empty?
        flash.now[:warning] = "A field has been left empty"
      else
      
        @reset_user.password = params[:members_admin_user][:password]
        @reset_user.password_confirmation = params[:members_admin_user][:password_confirmation]
  ...
  private
    ...
    def load_user_using_perishable_token
      ...
      @reset_user = Members::AdminUser.find_using_perishable_token params[:token]
